...
let fetchData = async ()=>{
    try{
        const res = await fetch('../json/api_comercial.json');// el archivo Json es llamado dede el index
...
const pintarCards = data => {
    data.forEach((producto, index) => {
        ...
        templateCard.querySelector('img').setAttribute('src', "../img/heladera.png")
